...
if(isset($name) || isset($adresse)|| isset($cuisine)){


$sql = $db->prepare("SELECT * FROM restaurants WHERE nom='$name' OR addresse='$adresse' OR cuisine='$cuisine' ");
$sql->execute();
while ($s = $sql->fetch(PDO::FETCH_OBJ)) {
	?>
                                 ...
                                 <h5> Telephone:</h5><?php echo $s->siteweb;?> <br>
                                 <h5> Addresse:</h5><?php echo $s->addresse;?> <br>
                                 <h5> Telephone:</h5><?php echo $s->cuisine;?> <br>
