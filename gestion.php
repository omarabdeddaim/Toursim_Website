...
if (isset($_POST['hotel'])) {
 			...
 			header('location: gestionhotel.php');
 		}
 	
 if (isset($_POST['restaurant'])) {
 			header('location: gestionrestaurant.php');
 		}
 ?>
<!DOCTYPE HTML>
<html>
		...
		<div id="page-wrapper">
			...
			<!-- Main -->
				<div id="main-wrapper">
					<div class="container">
						<div id="content">
							<center><h2>Gestion/Contrôl</h2><br><br><br>
  	                          <form action="" method="POST">

							     <button type="submit" class="btn btn-secondary" name="restaurant">Gestion Retaurant</button>
							     &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
							     <button type="submit" class="btn btn-dark" name="hotel">Gestion Hotel</button>
