...
.success {
  ...
  <body class="is-preload homepage">
    <div id="page-wrapper">
      ...
      <!-- Main -->
        <div class="container"><center><h2>Gestion des Restaurants</h2></center>
          <?php
          try {
...
$sql = $db->prepare("SELECT * FROM restaurants WHERE nom='$name'");
$sql->execute();
...
$sqql = $db->prepare("DELETE  FROM restaurants WHERE tel='$tel'");
$sqql->execute();
                                     }
                                     elseif (isset($_POST['modifier'])) {
$sqql = $db->prepare("UPDATE restaurants SET nom='$nom', services='$service', tel='$tel', siteweb='$siteweb', cuisine='$cuisine', addresse='$addresse' WHERE tel='$tel' ");
$sqql->execute();
                                     }
                                     elseif (isset($_POST['ajouter'])) {
$sqll = $db->prepare("INSERT INTO restaurants VALUES( NULL,'$nom', '$service', '$tel', '$siteweb', '$addresse','', '$cuisine') ");
$sqll->execute();
                                     }
                   ...
                   <form class="well form-horizontal" action="" method="POST">
                      <fieldset>
                         <div class="form-group">
                            <label class="col-md-4 control-label">Nom du Restaurant</label>
                         ...
                         <div class="form-group">
                            ...
                            <div class="col-md-8 inputGroupContainer">
                               <div class="input-group"><input id="addresse" name="addresse" class="form-control" required="true" value="<?php echo$s->addresse;?>" type="text"></div>
                            </div>
                         </div>
                         <div class="form-group">
                            <label class="col-md-4 control-label">Cuisine</label>
                            <div class="col-md-8 inputGroupContainer">
                               <div class="input-group"><input id="cuisine" name="cuisine" class="form-control" required="true" value="<?php echo$s->cuisine;?>" type="text"></div>
                            </div>
                         </div>
                         <div align="right">
