						...
						<!-- Nav -->
							<nav id="nav">
								<ul>
									...
									<li><a href="right-sidebar.php">RESTAURANT</a></li>
				...
				<div id="main-wrapper">
					<div class="container">
						<div id="content">
							...
							<a class="btn btn-primary" href="rechercher.php">Rechercher</a>
  	                          </div>
							     <?php
                                 ...
                                 <?php function affiche($rows)
                                   {
                                    ...
                                    echo "<center><h2> Listes des restaurants</h2><center> ";
								 ...
								 <div class="container mb-5 mt-5">
                                   ...
                                   <span class="h6 w-60 mx-auto px-4 py-1 rounded-bottom bg-primary text-white shadow-sm">Information</span>
                                    <div class="card-body pt-0">
                                <?php 
                                 echo "<h5>Nom du Restaurant:</h5>", $rows[$i][1], "<br> ";
                                 echo "<h5> Service:</h5>", $rows[$i][2], "<br> ";
                                 echo "<h5> Telephone:</h5>", $rows[$i][3], "<br>";
                                 echo "<h5> Site Web:</h5>", $rows[$i][4], "<br>";
                                 echo "<h5> Addresse:</h5>", $rows[$i][5], "<br>";
		                         echo "<h5> Cuisine:</h5>", $rows[$i][7], "<br>";
		                         ?>
                                 </div>
                                 </div>
